...
int main (int argc, char** argv){
    ...
    printf("pose_graph.txt load success! \n");
    if (pFile == NULL)
    {
    ...
    double VIO_Tx(0.0), VIO_Ty(0.0), VIO_Tz(0.0);
    double PG_Tx(0.0), PG_Ty(0.0), PG_Tz(0.0);
    double VIO_Qw(0.0), VIO_Qx(0.0), VIO_Qy(0.0), VIO_Qz(0.0);
    double PG_Qw(0.0), PG_Qx(0.0), PG_Qy(0.0), PG_Qz(0.0);
    double loop_info_0(0.0), loop_info_1(0.0), loop_info_2(0.0), loop_info_3(0.0);
    double loop_info_4(0.0), loop_info_5(0.0), loop_info_6(0.0), loop_info_7(0.0);
    int loop_index(0);
    int keypoints_num(0),densepoints_num(0);
