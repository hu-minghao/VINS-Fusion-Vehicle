...
//static octomap::OcTree* octo_map = new octomap::OcTree(0.03);
...
public:
	...
	//2021-8-12 hmh
	nav_msgs::Path loop_base_link_path;
	...
	//添加里程计回环漂移信息 2021-8-12 hmh
	Vector3d t_drift_baselink;
	Matrix3d r_drift_baselink;
	Matrix3d yaw_r_drift_baselink;
	//加载姿态图的大小
	int load_pose_graph_size;
...
private:
	...
	ros::Publisher pub_loop_id;
	//2021-8-12
	//ros::Publisher pub_loop_base_link_path;
	//ros::Publisher pub_base_link_path;
